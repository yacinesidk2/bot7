...
$mail = strtolower($mail);
        if(mb_substr($mail, -10) === '@gmail.com'){
         ...
         } elseif(strpos($mail, 'gmx.com')){
           	return checkGmx($mail);
        } else {
            return false;
...
curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Linux; Android 10; SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36"); 
...
$header[] = "User-Agent: Mozilla/5.0 (Linux; Android 10; SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36"; 
$header[] = "Accept: */*"; 
...
'content-type: application/json; charset=UTF-8',
'cookie: MUID\u003d02936a10b7024656a48e835c3419d5b6; MSCC\u003d93.23.250.190-FR; uaid\u003d819d2f54181a491ba71ccbdea3b49e49; MSPRequ\u003did\u003d292841\u0026lt\u003d1620260024\u0026co\u003d0; OParams\u003d11DZiQwSfxEf1!kxzqRlEhbY9dfYzaxPjTK!G0ksPbIz7rphHUVNIVKD5qnyG0D5!8WNbitFIg1TKqiwhxELqSZbySyROk54yFxIB!6!PTULEu564sMva98prYIOgegoc!SPdrNEAQfDjKHXLifIJIi0fyGrFSd0GL0ngU!uOCIjDpBOGG1V3J8LztEtxq8KC6ChXIza1*L0s9KbLDFMIleQz8so3vAip8WDW9uhxo0OcY5z0ma!AAjmqs7RzAnaR6X679aAe9hO5ey8PWFM!8qiHxT0mFJeP5bVS!Tz5SdQWKOb3QKZ5sjpE!3VWNTLTn0VH9pe9PaqOYhV6p9y!GGqhCnrWaNrJfFhncsNZrja*HmETyi36IIYAFJxq*BOkuANwEmu69KPNsgBXKxaFDZ04ZDQObZlJtIg5c2Iwr2DLbSJwI1JWF8ITKMaqP4BI6pSOvlV6EvhpPfSXoYdD!45ygtM5UFwFKoefw!CS2PStb4kAjsE23NQ*q49h7uxgAAfPPWo843Di4jtSkULfzkgUTnvtn9C5NpVOQdXrmfNV9FLn24D13o1xskbbT3Luixv*yl5ZRNpVXu!0Spb0feeYO0kwNBtKe01J9R!PiZiqHxh1i*uJYmqH44ndEP6RllcMGIzqICvF52Q33uNhG25UMuM89D6vSQRNtxdjbeUH934JG4zl0Y0*Rb5gbFrug!H0f4DDXFbRAafCUcLe2AGVBKsLf3YlBTmhTGOcpg6QrnbSnHZ3*MbdXB27z*6JcMuN3Zw8WWigCtLlBBYOmWre61BnDxOgww*lcagSMa9X1VrPBrUtNIRpOui623AGbQK4yh4YUQoEsyFwDqOMDDOtkpj87NFRKRpNE5TqxF6MxdeKnMbY94Eo2Q2kXTlP9AC113YLjGx9ZQrccie1sf*ArCauhero4SDyqxN1760RQTFIivNpcZZsrDaVjxxlymhKVyNIxZvpAUwh5FeLJlihFDDrUHEoYcByYUFeaooba; MSPOK\u003d$uuid-8e25a795-fe52-43a4-9814-fb103931c1f3$uuid-33852cf9-6d09-4802-9218-30b00ec8fbe6',
'hpgact: 0',
'hpgid: 38',
...
function checkGmx($mail){
    $mail = trim($mail);
    if(strpos($mail, ' ') or strpos($mail, '+')){
        return false;
    }
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL,"https://login.gmx.com/login=");
  curl_setopt($ch,CURLOPT_HTTPHEADER, [
    'Host: login.gmx.com',
'Connection: keep-alive',
'User-Agent: Mozilla/5.0 (Linux; Android 10; SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36',
